...
% add right-side logo
% \headerlogoright{\includegraphics[width=0.1\paperwidth]{assets/uvt-logo-fmi.png}}
...
% Add content to the footer. If this command is not defined, the footer is
% not shown in the final poster.
\footercontent{
